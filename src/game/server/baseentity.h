...
#include "bittools.h"
#ifdef PORTAL2
//#include "portal2/paintable_object.h"
#endif
...
public:
	...
	virtual void			SetMoveType( MoveType_t val, MoveCollide_t moveCollide = MOVECOLLIDE_DEFAULT );
...
#ifdef PORTAL2
	// May not need to be virtual, but useful just in case
//	virtual void Paint(Color paintColor);
//	virtual void RemovePaint(inputdata_t& inputdata);
//	virtual void TraceForPaint();
#endif
