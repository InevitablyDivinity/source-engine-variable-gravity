...
#if (defined(SDK_DLL) || defined(HORIZON))
#include "matchmaking/swarm/imatchext_swarm.h"
#endif // SDK_DLL
...
#if defined(PORTAL2) && defined(DEBUG)
	if (!engine->HasPaintMap())
		DevMsg("Map doesn't paintmaps enabled!\n"); // check this follows Portal 2's mapspawn behaviour
#endif
