...
CHorizon_Loading_Panel *g_pHorizon_Loading_Panel = NULL;

CUtlVector<CHorizon_Loading_Panel *> g_vecLoadingPanels;
...
{
	if ( NULL == g_pHorizon_Loading_Panel )
	{
		g_pHorizon_Loading_Panel = new CHorizon_Loading_Panel();
	}
	return g_pHorizon_Loading_Panel;
}
...
void DestroyHorizonLoadingPanel()
{
	if ( NULL != g_pHorizon_Loading_Panel)
	{
		delete g_pHorizon_Loading_Panel;
		g_pHorizon_Loading_Panel = NULL;
	}
}
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHorizon_Loading_Panel::CHorizon_Loading_Panel() : BaseClass( NULL, "Horizon_Loading_Panel", 
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
void CHorizon_Loading_Panel::Init( void )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHorizon_Loading_Panel::CHorizon_Loading_Panel( vgui::Panel *parent ) : BaseClass( parent, "TFStatsSummary", 
																		  vgui::scheme()->LoadSchemeFromFile( "Resource/ClientScheme.res", "ClientScheme" ) )
{
	Init();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
CHorizon_Loading_Panel::~CHorizon_Loading_Panel()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHorizon_Loading_Panel::PerformLayout()
{
...
//-----------------------------------------------------------------------------
void CHorizon_Loading_Panel::ApplySchemeSettings(vgui::IScheme *pScheme)
{
...
void CHorizon_Loading_Panel::GetLoadingScreenSize(int &w, int &t, int &xoffset)
{
	int sw, sh;
	vgui::surface()->GetScreenSize( sw, sh );
...
void CHorizon_Loading_Panel::FireGameEvent( IGameEvent *event )
{
...
void CHorizon_Loading_Panel::SetLoadingMapName( const char *szMapName )
{
	m_pDetailsPanel->SetVisible( false );
	if ( !szMapName )
		return;
...
void CHorizon_Loading_Panel::SetGenerationOptions( KeyValues *pKeys )
{
