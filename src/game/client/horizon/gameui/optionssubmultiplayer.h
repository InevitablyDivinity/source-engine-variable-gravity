...
class CHorizoneledCommandComboBox;
...
private:
	void InitModelList(CHorizoneledCommandComboBox *cb);
	void InitLogoList(CHorizoneledCommandComboBox *cb);
	...
	CHorizoneledCommandComboBox *m_pModelList;
	char m_ModelName[128];

	vgui::ImagePanel *m_pLogoImage;
	CHorizoneledCommandComboBox *m_pLogoList;
    char m_LogoName[128];
	...
	// --- crosshair controls ----------------------------------
	CHorizoneledCommandComboBox *m_pCrosshairSize;
	void InitCrosshairSizeList(CHorizoneledCommandComboBox *cb);
	...
	CHorizoneledCommandComboBox *m_pAdvCrosshairStyle;

	void InitAdvCrosshairStyleList(CHorizoneledCommandComboBox *cb);
