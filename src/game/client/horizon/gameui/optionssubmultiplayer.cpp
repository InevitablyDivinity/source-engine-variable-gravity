...
COptionsSubMultiplayer::COptionsSubMultiplayer(vgui::Panel *parent) : vgui::PropertyPage(parent, "OptionsSubMultiplayer") 
{
	...
	m_pModelList = new CHorizoneledCommandComboBox( this, "Player model" );
	m_ModelName[0] = 0;
	InitModelList( m_pModelList );

	m_pLogoList = new CHorizoneledCommandComboBox( this, "SpraypaintList" );
    m_LogoName[0] = 0;
	...
	m_pCrosshairSize = new CHorizoneledCommandComboBox(this, "CrosshairSizeComboBox");
	...
	m_pAdvCrosshairStyle = new CHorizoneledCommandComboBox( this, "AdvCrosshairList" );
...
//-----------------------------------------------------------------------------
void COptionsSubMultiplayer::InitLogoList( CHorizoneledCommandComboBox *cb )
{
	// Find out images
	FileFindHandle_t fh;
	char directory[ 512 ];
...
void FindVMTFilesInFolder( const char *pFolder, const char *pFolderName, CHorizoneledCommandComboBox *cb, int &iCount, int &iInitialItem )
{
...
//-----------------------------------------------------------------------------
void COptionsSubMultiplayer::InitModelList( CHorizoneledCommandComboBox *cb )
{
	// Find out images
	int i = 0, initialItem = 0;
...
//-----------------------------------------------------------------------------
void COptionsSubMultiplayer::InitCrosshairSizeList(CHorizoneledCommandComboBox *cb)
{
	if (cb == NULL)
	{
		return;
...
//-----------------------------------------------------------------------------
void COptionsSubMultiplayer::InitAdvCrosshairStyleList(CHorizoneledCommandComboBox *cb)
{
	// Find out images
	FileFindHandle_t fh;
	char directory[ 512 ];
