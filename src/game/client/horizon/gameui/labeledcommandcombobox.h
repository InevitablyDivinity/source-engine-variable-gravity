...
class CHorizoneledCommandComboBox : public vgui::ComboBox
{
	DECLARE_CLASS_SIMPLE( CHorizoneledCommandComboBox, vgui::ComboBox );

public:
	CHorizoneledCommandComboBox(vgui::Panel *parent, const char *panelName);
	~CHorizoneledCommandComboBox();
