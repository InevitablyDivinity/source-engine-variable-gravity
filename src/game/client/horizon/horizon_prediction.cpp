...
class CHorizon_Prediction : public CPrediction
{
DECLARE_CLASS( CHorizon_Prediction, CPrediction );
...
CHorizon_Prediction::CHorizon_Prediction()
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHorizon_Prediction::SetupMove( C_BasePlayer *player, CUserCmd *ucmd, IMoveHelper *pHelper, 
	CMoveData *move )
{
...
//			*u - 
//-----------------------------------------------------------------------------
void CHorizon_Prediction::RunCommand( C_BasePlayer *player, CUserCmd *ucmd, IMoveHelper *moveHelper )
{
	BaseClass::RunCommand( player, ucmd, moveHelper );
}

void CHorizon_Prediction::FinishMove( C_BasePlayer *player, CUserCmd *ucmd, CMoveData *move )
{
...
// Expose interface to engine
static CHorizon_Prediction g_Prediction;

EXPOSE_SINGLE_INTERFACE_GLOBALVAR( CHorizon_Prediction, IPrediction, VCLIENT_PREDICTION_INTERFACE_VERSION, g_Prediction );
