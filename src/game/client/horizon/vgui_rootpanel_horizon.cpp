...
//-----------------------------------------------------------------------------
class C_HorizonRootPanel : public vgui::Panel
{
	typedef vgui::Panel BaseClass;
public:
	C_HorizonRootPanel( vgui::VPANEL parent, int slot );
	virtual				~C_HorizonRootPanel( void );
...
//-----------------------------------------------------------------------------
// C_HorizonRootPanel implementation.
//-----------------------------------------------------------------------------
C_HorizonRootPanel::C_HorizonRootPanel( vgui::VPANEL parent, int slot )
...
// Purpose: 
//-----------------------------------------------------------------------------
C_HorizonRootPanel::~C_HorizonRootPanel( void )
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_HorizonRootPanel::PostChildPaint()
{
...
//-----------------------------------------------------------------------------
void C_HorizonRootPanel::RenderPanelEffects( void )
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_HorizonRootPanel::OnTick( void )
{
}
...
//-----------------------------------------------------------------------------
void C_HorizonRootPanel::LevelInit( void )
{
}

void C_HorizonRootPanel::LevelShutdown( void )
{
}

void C_HorizonRootPanel::PaintTraverse( bool Repaint, bool allowForce /*= true*/ )
{
	ACTIVE_SPLITSCREEN_PLAYER_GUARD( m_nSplitSlot);
	BaseClass::PaintTraverse( Repaint, allowForce );
}

void C_HorizonRootPanel::OnThink()
{
	ACTIVE_SPLITSCREEN_PLAYER_GUARD( m_nSplitSlot );
	BaseClass::OnThink();
}

static C_HorizonRootPanel *g_pRootPanel[ MAX_SPLITSCREEN_PLAYERS ];
static C_HorizonRootPanel *g_pFullscreenRootPanel;
...
void VGUI_CreateClientDLLRootPanel( void )
{
	for ( int i = 0 ; i < MAX_SPLITSCREEN_PLAYERS; ++i )
	{
		g_pRootPanel[ i ] = new C_HorizonRootPanel( enginevgui->GetPanel( PANEL_CLIENTDLL ), i );
	}

	g_pFullscreenRootPanel = new C_HorizonRootPanel( enginevgui->GetPanel( PANEL_CLIENTDLL ), 0 );
