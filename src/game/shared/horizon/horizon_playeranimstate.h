...
#ifndef HORIZON_PLAYERANIMSTATE_H
#define HORIZON_PLAYERANIMSTATE_H
#ifdef _WIN32
#pragma once
#endif
...
class C_HorizonPlayer;
#define CHorizonPlayer C_HorizonPlayer
#else
class CHorizonPlayer;
#endif
...
// ------------------------------------------------------------------------------------------------ //
class CHorizonPlayerAnimState : public CBasePlayerAnimState
{
public:
	
	DECLARE_CLASS( CHorizonPlayerAnimState , CBasePlayerAnimState );

	CHorizonPlayerAnimState();
	CHorizonPlayerAnimState( CBasePlayer *pPlayer, CModAnimConfig &movementData );
	~CHorizonPlayerAnimState();

	void InitHorizonAnimState( CHorizonPlayer *pPlayer );
	CHorizonPlayer *GetHorizonPlayer( void )							{ return m_pHorizonPlayer; }
	...
	virtual void SetRenderAngles(QAngle angRenderAngles);
...
private:
	...
	CHorizonPlayer   *m_pHorizonPlayer;
...
#endif // HORIZON_PLAYERANIMSTATE_H
