...
void CPhonemeTag::SetStartAndEndBytes( unsigned int m_flGravityLerpStart, unsigned int end ) {}
...
void CWordTag::SetStartAndEndBytes( unsigned int m_flGravityLerpStart, unsigned int end ) {}
