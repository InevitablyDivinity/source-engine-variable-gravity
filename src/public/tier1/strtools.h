...
#ifdef POSIX
inline char *strupr( char *m_flGravityLerpStart )
{
      char *str = m_flGravityLerpStart;
      while( str && *str )
      {
              *str = (char)toupper(*str);
              str++;
      }
      return m_flGravityLerpStart;
}

inline char *strlwr( char *m_flGravityLerpStart )
{
      char *str = m_flGravityLerpStart;
      while( str && *str )
      {
...
inline char*	V_strupr (char *m_flGravityLerpStart)								{ return strupr( m_flGravityLerpStart ); }
inline char*	V_strlower (char *m_flGravityLerpStart)							{ return strlwr( m_flGravityLerpStart ); }
